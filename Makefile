...
OLDCC = ./xgcc -nostdinc -B/os2/bin/ -I/os2/h
...
GCC_FOR_TARGET = ./xgcc -v -nostdinc -B/os2/bin/ -I/os2/h
...
target=i386-pc-linux-gnuaout
target_alias=i386-pc-linux-gnuaout
xmake_file=
tmake_file= ./config/t-linux-aout ./config/i386/t-crtstuff
out_file=$(srcdir)/config/i386/i386.c
out_object_file=i386.o
md_file=$(srcdir)/config/i386/i386.md
tm_file= $(srcdir)/config/i386/linux-aout.h
build_xm_file= $(srcdir)/config/alpha/xm-alpha.h $(srcdir)/config/alpha/xm-linux.h
host_xm_file= $(srcdir)/config/auto-config.h $(srcdir)/config/alpha/xm-alpha.h $(srcdir)/config/alpha/xm-linux.h
...
LANG_DIFF_EXCLUDES =  -x parse.c -x parse.h -x objc-parse.c -x objc-parse.y 
